...
def render_html(payload: dict) -> str:
    ...
    pieces = [
        ...
        (
            ...
            "body{margin:40px auto;max-width:900px;font-family:Montserrat,sans-serif;color:#2d2b26;line-height:1.6}"
            "h1,h2,h3{color:#174a96;font-weight:700}"
            "table{width:100%;border-collapse:collapse;margin-bottom:20px;background:#fff}"
            "th,td{border:1px solid #dadada;padding:8px;text-align:left;vertical-align:top;white-space:pre-wrap;word-break:break-word}"
            "th{background:#f0f0f0}"
            ".transcription{border:1px solid #dadada;padding:16px;margin:20px 0;background:#fff}"
            ".note-section{border:1px solid #dadada;padding:16px;margin:20px 0;background:#fff}"
